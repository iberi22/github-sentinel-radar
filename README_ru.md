...
6. **🔍 Очередь проверки (решение человека)**: Делит подписчиков и отслеживаемых на надёжных / возможных ботов с % доверия, причинами и ссылками. Автоблокировки нет: отметьте, скопируйте и заблокируйте через workflow.
